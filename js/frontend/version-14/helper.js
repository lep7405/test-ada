...
try {
  ...
  var languageModule=  (function(language) {
    ...
    const labelTranslations = {
      'en':    { label_name: 'Your name',     label_email: 'Your email',     label_text_area: 'Your feedback',  field_required: 'This field is required',              email_invalid: 'Please enter a valid email address',              review_by_label: 'Review by {{author}}' },
      'de':    { label_name: 'Dein Name',     label_email: 'Deine E-Mail',   label_text_area: 'Ihr Feedback',   field_required: 'Dieses Feld ist erforderlich',        email_invalid: 'Bitte geben Sie eine gültige E-Mail-Adresse ein', review_by_label: 'Bewertung von {{author}}' },
      'fr':    { label_name: 'Votre nom',     label_email: 'Votre e-mail',   label_text_area: 'Votre avis',     field_required: 'Ce champ est obligatoire',            email_invalid: 'Veuillez entrer une adresse e-mail valide',       review_by_label: 'Avis de {{author}}' },
      'es':    { label_name: 'Tu nombre',     label_email: 'Tu correo',      label_text_area: 'Tu opinión',     field_required: 'Este campo es obligatorio',           email_invalid: 'Por favor, introduce una dirección de correo válida', review_by_label: 'Reseña de {{author}}' },
      'hi':    { label_name: 'तुम्हारा नाम', label_email: 'तुम्हारा ईमेल', label_text_area: 'आपकी समीक्षा',  field_required: 'यह फ़ील्ड आवश्यक है',               email_invalid: 'कृपया एक वैध ईमेल पता दर्ज करें',               review_by_label: '{{author}} की समीक्षा' },
      'pt':    { label_name: 'Seu nome',      label_email: 'Seu email',      label_text_area: 'Seu feedback',   field_required: 'Este campo é obrigatório',            email_invalid: 'Por favor, insira um endereço de e-mail válido',  review_by_label: 'Avaliação de {{author}}' },
      'pt-BR': { label_name: 'Seu nome',      label_email: 'Seu email',      label_text_area: 'Seu feedback',   field_required: 'Este campo é obrigatório',            email_invalid: 'Por favor, insira um endereço de e-mail válido',  review_by_label: 'Avaliação de {{author}}' },
      'zh':    { label_name: '你的名字',       label_email: '你的邮件',        label_text_area: '您的評論',        field_required: '此字段为必填项',                       email_invalid: '请输入有效的电子邮件地址',                          review_by_label: '{{author}} 的评论' },
      'zh-TW': { label_name: '你的名字',       label_email: '你的邮件',        label_text_area: '您的評論',        field_required: '此欄位為必填',                         email_invalid: '請輸入有效的電子郵件地址',                          review_by_label: '{{author}} 的評論' },
      'ja':    { label_name: 'あなたの名前',   label_email: 'メールアドレス',  label_text_area: 'ご意見',          field_required: 'このフィールドは必須です',              email_invalid: '有効なメールアドレスを入力してください',            review_by_label: '{{author}} のレビュー' },
      'ko':    { label_name: '이름',           label_email: '이메일',          label_text_area: '리뷰',            field_required: '필수 입력 항목입니다',                 email_invalid: '유효한 이메일 주소를 입력하세요',                   review_by_label: '{{author}} 님의 리뷰' },
      'it':    { label_name: 'Il tuo nome',   label_email: 'La tua email',   label_text_area: 'Il tuo feedback', field_required: 'Questo campo è obbligatorio',         email_invalid: 'Inserisci un indirizzo email valido',             review_by_label: 'Recensione di {{author}}' },
      'nl':    { label_name: 'Jouw naam',     label_email: 'Jouw e-mail',    label_text_area: 'Jouw feedback',   field_required: 'Dit veld is verplicht',               email_invalid: 'Voer een geldig e-mailadres in',                  review_by_label: 'Beoordeling van {{author}}' }
    };
    ...
    function getLanguage(language) {
      return {
        ...
        'accessibility-review_by_label' : getLabelByLang('review_by_label'),
